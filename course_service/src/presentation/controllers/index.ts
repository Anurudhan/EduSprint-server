...
import { addCourseController, deleteCloudinaryConntroller, getAllCourseController, getCourseByIdController, getCourseByInstructorController, streamVideoController, updateCourseController } from "./course";
...
export const controller = (dependencie:IDependencies) => {
    return {
        ...
        deleteCloudinary:deleteCloudinaryConntroller()
    }
}